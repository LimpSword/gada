...
func getExpected() map[string]testlexer {
	...
	tokens1 = append(tokens1, lexer.Token{"", 6, token.IDENT, lexer.Position{5, 34}, lexer.Position{5, 41}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 7, token.IDENT, lexer.Position{5, 43}, lexer.Position{5, 47}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 8, token.IDENT, lexer.Position{5, 50}, lexer.Position{5, 57}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 9, token.IDENT, lexer.Position{5, 66}, lexer.Position{5, 73}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 10, token.IDENT, lexer.Position{6, 4}, lexer.Position{6, 8}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 13, token.IDENT, lexer.Position{8, 15}, lexer.Position{8, 19}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 19, token.IDENT, lexer.Position{12, 39}, lexer.Position{12, 46}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 20, token.IDENT, lexer.Position{12, 48}, lexer.Position{12, 52}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 21, token.IDENT, lexer.Position{12, 55}, lexer.Position{12, 62}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 24, token.IDENT, lexer.Position{13, 8}, lexer.Position{13, 15}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 25, token.IDENT, lexer.Position{15, 7}, lexer.Position{15, 8}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 26, token.IDENT, lexer.Position{15, 12}, lexer.Position{15, 16}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 27, token.INT, lexer.Position{15, 17}, lexer.Position{15, 18}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 28, token.IDENT, lexer.Position{15, 21}, lexer.Position{15, 25}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 29, token.INT, lexer.Position{15, 26}, lexer.Position{15, 27}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 30, token.IDENT, lexer.Position{16, 11}, lexer.Position{16, 12}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 31, token.IDENT, lexer.Position{17, 8}, lexer.Position{17, 26}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 32, token.IDENT, lexer.Position{20, 1}, lexer.Position{20, 6}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 33, token.IDENT, lexer.Position{20, 9}, lexer.Position{20, 16}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 34, token.IDENT, lexer.Position{25, 4}, lexer.Position{25, 9}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 35, token.INT, lexer.Position{25, 13}, lexer.Position{25, 14}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 36, token.IDENT, lexer.Position{27, 7}, lexer.Position{27, 12}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 37, token.INT, lexer.Position{27, 15}, lexer.Position{27, 16}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 40, token.INT, lexer.Position{28, 41}, lexer.Position{28, 42}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 41, token.INT, lexer.Position{28, 43}, lexer.Position{28, 44}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 42, token.IDENT, lexer.Position{29, 10}, lexer.Position{29, 13}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 44, token.IDENT, lexer.Position{30, 12}, lexer.Position{30, 18}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 45, token.IDENT, lexer.Position{30, 22}, lexer.Position{30, 35}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 46, token.INT, lexer.Position{30, 36}, lexer.Position{30, 37}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 47, token.INT, lexer.Position{30, 38}, lexer.Position{30, 39}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 48, token.IDENT, lexer.Position{31, 10}, lexer.Position{31, 13}})
	...
	tokens1 = append(tokens1, lexer.Token{"", 49, token.IDENT, lexer.Position{31, 14}, lexer.Position{31, 20}})
